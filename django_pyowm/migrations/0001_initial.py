# Generated by Django 3.0.4 on 2020-04-24 01:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_weather', models.ForeignKey(blank=True, help_text='Last weather', null=True, on_delete=django.db.models.deletion.CASCADE, to='django_pyowm.Weather', verbose_name='Last weather measured by the station')),
            ],
        ),
        migrations.CreateModel(
            name='SO2Index',
...
ion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_pyowm.Weather')),
            ],
        ),
        migrations.CreateModel(
            name='NO2Index',
            fields=[
                ...
                ('interval', models.CharField(choices=[('minute', 'One minute'), ('hour', 'One hour'), ('day', 'One day'), ('month', 'One month'), ('year', 'One year')], max_length=255, verbose_name='Time granularity of the observation')),
                ('reception_time', models.DateTimeField(blank=True, help_text='Reception time', null=True, verbose_name='Time the observation was received')),
                ('no2_samples', models.TextField(help_text='NO2 samples', verbose_name='NO2 samples data')),
                ('location', models.ForeignKey(help_text='Location', on_delete=django.db.models.deletion.CASCADE, to='django_pyowm.Location', verbose_name='Location of the observation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reception_time', models.DateTimeField(blank=True, help_text='Reception time', null=True, verbose_name='Time the observation was received')),
                ('location', models.ForeignKey(help_text='Location', on_delete=django.db.models.deletion.CASCADE, to='django_pyowm.Location', verbose_name='Location of the forecast')),
                ('weathers', models.ManyToManyField(help_text='Weathers', related_name='forecasts', to='django_pyowm.Weather', verbose_name='Weathers of the forecast')),
            ],
        ),
        migrations.CreateModel(
            name='COIndex',
